...
impl<K, V, S> CowEntry for HashMap<K, V, S>
where
    K: Hash + Eq,
    S: BuildHasher,
{
...
impl<'m, 'q, K, V, S, Q> CowEntryMut<'m, 'q, K, V, S, Q>
where
    K: Hash + Eq + Borrow<Q>,
    ...
    S: BuildHasher,
{
    ...
    pub fn and_modify(self, f: impl FnOnce(&mut V)) -> Self {
        match self {
            ...
            CowEntryMut::Vacant(v) => CowEntryMut::Vacant(v),
        }
    }
...
impl<'m, 'q, K, V, S, Q> CowOccupiedEntryMut<'m, 'q, K, V, S, Q>
where
    K: Hash + Eq + Borrow<Q>,
    Q: ?Sized + Hash + Eq + ToOwned<Owned = K>,
    S: BuildHasher,
...
impl<'m, 'q, K, V, S, Q> CowVacantEntryMut<'m, 'q, K, V, S, Q>
where
    K: Hash + Eq + Borrow<Q>,
    Q: ?Sized + Hash + Eq + ToOwned<Owned = K>,
    S: BuildHasher,
