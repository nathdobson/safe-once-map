...
//
impl<K, V, F, S, RF: RawFused, RM> LazyMap<K, V, F, S, RF, RM>
where
...
impl<K, V, F, S, RF, RM> FnOnce<K> for LazyMap<K, V, F, S, RF, RM>
where
    K: Tuple + Eq + Hash + Clone,
    RF: RawFused,
    V: Clone,
...
impl<K, V, F, S, RF, RM> FnMut<K> for LazyMap<K, V, F, S, RF, RM>
where
    K: Tuple + Eq + Hash + Clone,
    RF: RawFused,
    V: Clone,
...
impl<K, V, F, S, RF, RM> Fn<K> for LazyMap<K, V, F, S, RF, RM>
where
    K: Tuple + Eq + Hash + Clone,
    RF: RawFused,
    V: Clone,
